...
* **Пресеты цветов:** Быстрое применение фирменных цветов крупных компаний для генерации фона ("Крокодил", "Красная панда", "Т1" и др.).
...
### 1.1. Производительность и системные требования

Наша система сегментации демонстрирует высокую эффективность использования ресурсов:
...
> 💡 **Примечание:** Благодаря низкому потреблению ресурсов, приложение может работать параллельно с другими задачами без снижения производительности системы.
...
<p align="center">
  <img src="/pics/Generator.jpeg" alt="Генератор" width="700">
</p>
...
<p align="center">
  <img src="/pics/Urovni.jpeg" alt="Уровни" width="700">
</p>
...
<p align="center">
  <img src="/pics/Red.jpeg" alt="Добавление" width="700">
</p>
...
Для тонкой настройки производительности (уменьшение задержки и повышение FPS) можно отредактировать файл `t1_segmentation_hack-main/Tech/public/segmentation.js`:
